...
$ucapan = mysqli_query($conn, "SELECT *FROM ucapan ORDER BY id DESC");


// cari data
if (isset($_POST["cari"])) {
    $ucapan = cari($_POST["keyword"]);
}
...
{
    $query = "SELECT *FROM ucapan WHERE nama LIKE '%$keyword%' OR komentar LIKE '%$keyword%' OR waktu LIKE '%$keyword%' ORDER BY id DESC";
    return query($query);
}
// end cari
            ...
            <div class="col-auto col-md-3 col-xl-3 px-sm-2 px-0 sidebar">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-left align-items-sm-start" id="menu">
                        ...
                        <li>
                            <a href="ucapan" class="nav-link px-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($ucapan as $crs) : ?>
                            <tr>
                                ...
                                <td><?= $crs["komentar"]; ?></td>
                                <td class="waktu"><?= $crs["waktu"]; ?></td>
                                <td><a href="delete.php?id=<?= $crs['id'] ?>" class="btn d-flex align-items-center delete text-danger" onclick="return confirm('Yakin Ingin Menghapus')"><span class="material-icons">delete</span> Hapus</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
